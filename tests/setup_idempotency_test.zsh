...
test_brewfile_contains_only_approved_formulae() {
  ...
  expected_formulae="$(print -l \
    cocoapods coreutils efl ffmpeg git gnupg htop ideviceinstaller ios-deploy mas mingw-w64 mole \
    pinentry-mac sqlite ssh-copy-id syncthing telnet wget wxwidgets | LC_ALL=C sort)"
